...
class VMM(nn.Module):
    ...
    def forward_core(self, x: torch.Tensor, 
        ...
        return mair_ids_inverse(out_y, mair_ids[1], shape=(B, -1, H, W))
...
class RMB(nn.Module):
    ...
    def _generate_ids(self):
        ...
        xs_shift_scan_ids, xs_shift_inverse_ids = mair_shift_ids_generate(inp_shape=(1, 1, H, W), scan_len=self.scan_len, shift_len=self.scan_len//2)

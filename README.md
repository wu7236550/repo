...
- `src/` — source code for training, validation, inference and evaluation,
  including the three proposed modules (CSP-PMSFA, RepNCSPELAN4_CAA, DPB-AIFI)
...
python train.py --data ../configs/roadrdd.yaml \
    --cfg ultralytics/cfg/models/rt-detr/rtdetr-CSP-PMSFA_RepNCSPELAN4_CAA_TransformerEncoderLayer_DPB.yaml \
